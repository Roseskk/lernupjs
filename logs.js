...
export const consoleGame = document.querySelector('.chat');

export  const time = (time) => time < 10 ? `0${time}` : time;
...
export  const logs = (type, player1, player2, damage = 0) => {
    ...
    consoleGame.insertAdjacentHTML('afterbegin', `<p>${console}</p>`);
};
